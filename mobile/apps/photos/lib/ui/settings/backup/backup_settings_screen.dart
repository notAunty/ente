                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      MenuItemWidgetNew(
                        title: 'Keep temporary preview after delete',
                        subText:
                            'For backed up photos, keep a small preview cache after Delete from device or Free up device storage.',
                        subTextMaxLines: 3,
                      ...
                      if (_canUseSharedProxyStorage) ...[
                        const SizedBox(height: 8),
                        MenuItemWidgetNew(
                          title: 'Write temporary previews to shared storage',
                          subText:
                              'Android only. When deleting from device, write preview cache files to "Pictures/ente Proxies".',
                          subTextMaxLines: 2,
                          titleToSubTextSpacing: 4,
                          trailingWidget: ToggleSwitchWidget(
                            value: () =>
